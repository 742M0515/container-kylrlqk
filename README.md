...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kylrlqk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kylrlqk.containers.anotherwebservice.com/
...
```
git clone git@github.com:742M0515/container-kylrlqk.git
cd container-kylrlqk
```
...
```
docker attach container-kylrlqk
```
